...
public class AuthService {
    ...
    public UserResponseDTO register(RegisterRequestDTO registerRequest){
        ...
        return new UserResponseDTO(savedUser.getId(), savedUser.getUsername(), savedUser.getEmail(), savedUser.getFirstName(), savedUser.getLastName(),  savedUser.getBirthday(), savedUser.getLearningLanguage(),savedUser.getProfileImage(),savedUser.getAbout());
