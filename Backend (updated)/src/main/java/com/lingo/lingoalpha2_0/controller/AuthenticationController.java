...
public class AuthenticationController {
    ...
    public authResponseDTO authenticateUser(@RequestBody LoginRequestDTO loginRequest){
        ...
        UserResponseDTO userResponseDTO = new UserResponseDTO(user.getId(), user.getUsername(), user.getEmail(), user.getFirstName(), user.getLastName(), user.getBirthday(), user.getLearningLanguage(), user.getProfileImage(), user.getAbout());
